...
class HotelController extends Controller
{
    ...
    {
        $hotelmanagement = HotelManagement::find($request->id);
        File::delete(public_path('images/hotel/' . $hotelmanagement->photopath));
        File::delete(public_path('images/hotel/' . $hotelmanagement->photopath2));
        File::delete(public_path('images/hotel/' . $hotelmanagement->photopath3));
        File::delete(public_path('images/hotel/' . $hotelmanagement->photopath4));
        $hotelmanagement->delete();
        return redirect()->route('hotelmanagement.index')->with('success', 'Hotel Deleted Successfully');
    }
}
