...
Route::get('/roomdetails/{id}', [PagesController::class, 'roomdetails'])
    ->name('roomdetails');
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/hotelmanagement/destroy', [HotelController::class, 'destroy'])
        ->name('hotelmanagement.destroy');
    ...
    Route::get('/roommanagement/{id}/edit', [RoomController::class, 'edit'])
